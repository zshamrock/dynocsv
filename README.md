...
- only `String`, `Boolean`, `Number`, `Map` and `StringSet` data types are supported to export the data from, attributes with other data type will still be present, but the value will be "" (empty string)
